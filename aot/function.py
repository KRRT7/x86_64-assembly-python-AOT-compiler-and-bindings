...
from aot.utility import FUNCTION_ARGUMENTS, FUNCTION_ARGUMENTS_FLOAT, float_to_hex, load_floats, operand_is_float, str_to_type
from x86_64_assembly_bindings import (
    Block, Function, Instruction, InstructionData, MemorySize, OffsetRegister, Program, Register, RegisterData, Variable
)
            ...
            case "Add":
                ...
                if aug_assign:
                    ...
                    if not is_float:
                        ...
                        val1 = nval1
                    elif isinstance(val1, Register) and val1 in FUNCTION_ARGUMENTS_FLOAT:
            ...
            case "Mult":
                if is_float:
                    ...
                    if aug_assign:
                        ...
                        if isinstance(val1, Register) and val1 in FUNCTION_ARGUMENTS_FLOAT:
                            lines.append(Ins("movq", nval1:=req_reg(), val1))
