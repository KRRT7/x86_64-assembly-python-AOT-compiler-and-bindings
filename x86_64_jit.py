...
class Stack:
    ...
    def __contains__(self, key: str) -> bool:
        # Search only through active frames to optimize searches
        return any(key in frame for frame in reversed(self.stack[: self.cursor + 1]))
    ...
    def add_variable(self, key: str, value: OffsetRegister):
